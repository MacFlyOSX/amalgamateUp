        ...
        <div className="footer">
            <div className="footer-left">
                <p className="footer-left-text">
                    2022 AmalgamateUp &bull; Powered by: Brandon Tasaki
                </p>
            </div>
            <div className="footer-right">
                <a href='https://github.com/MacFlyOSX/amalgamateUp' target='_blank'>
                    <div className="github">
                        <img src={githubGrey} style={{ height: 35 }} alt='github' className="github-bottom"></img>
                        <img src={githubPurple} style={{ height: 35 }} alt='github' className="github-top"></img>
                    </div>
                </a>
                <a href='https://www.linkedin.com/in/brandon-tasaki/' target='_blank'>
                    <div className="linkedin">
                        <img src={linkedinGrey} style={{ height: 35 }} alt='linkedin' className="linkedin-bottom"></img>
                        <img src={linkedinBlue} style={{ height: 35 }} alt='linkedin' className="linkedin-top"></img>
                    </div>
                </a>
            </div>
        </div>
